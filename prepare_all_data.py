...
# - For each taxon, a GeoJSON file is generated with the current occurrences
#   (based on the Belgian cube and the EEA grid)
# - Finally, a JSON species list is generated and saved
...
for filename in os.listdir(SOURCE_DIR):
    ...
    # (filename contains GBIF's species ID)
...
species_ids_in_cube = create_occurrence_geojsons(
    destination_dir=OCCURRENCES_DESTINATION_DIR
)
