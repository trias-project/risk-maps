...
export default Vue.extend({
  ...
  data: function() {
    return {
      ...
      availableScenarii: [
        { value: null, text: '-- Please select an scenario --', disabled: true },
      ...
      availableMapTypes: [
        ...
        { value: '', text: 'risk map' },
        { value: 'diff', text: 'map of difference in risk between the RCP climate scenario risk maps and the risk map based on historical climate' },
        { value: 'conf', text: 'map of confidence of predicted risk for each risk map' },
      ],
  ...
  computed: {
    ...
    selectionMade: function(): boolean {
      return (this.climateScenarioId != null) && (this.speciesId != null) && (this.mapTypeId != null) ? true : false;
    }
  },
  components: {
    Map
